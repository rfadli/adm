  ...
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    ...
    <form class="navbar-form navbar-left" role="search">
      ...
      <button type="submit" class="btn btn-default">Submit</button>
        ...
        <a class="btn btn-success" href="/departement/add" role="button">+Add New</a>
		...
		foreach ($data as $dat)
		{
			...
			echo '<td>'.'<center>'.$dat['departement'].'</center>'.'</td>';
			echo '<td>'.'<center>'.$dat['deskripsi'].'</center>'.'</td>';
			echo '<td>'.'<center>';
			echo '<a href="/departement/edit?id='.$dat['_id'].'" class="label label-primary">edit</a>&nbsp';
			echo '<a href="/departement/delete?id='.$dat['_id'].'" onclick="return confirm(\' Anda Yakin?\')" class="label label-danger">delete</a>';
			echo '</center>'.'</td>';
			echo '</tr>';
		}
