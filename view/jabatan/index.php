      ...
      <button type="submit" class="btn btn-default">Submit</button>
		...
		<div class="container">	
			 <div class="blog-header">
		        <h1 class="blog-title">Jabatan</h1>
        ...
        <a class="btn btn-success" href="/jabatan/add" role="button">+Add New</a>
		...
		foreach ($data as $dat)
		{
			...
			echo '<td>'.'<center>'.$dat['jabatan'].'</center>'.'</td>';
			echo '<td>'.'<center>'.$dat['deskripsi'].'</center>'.'</td>';
			echo '<td>'.'<center>';
			echo '<a href="/jabatan/edit?id='.$dat['_id'].'" class="label label-primary">edit</a>&nbsp';
			echo '<a href="/jabatan/delete?id='.$dat['_id'].'" onclick="return confirm(\' Anda Yakin?\')" class="label label-danger">delete</a>';
			echo '</center>','</td>';
			echo '</tr>';
		}
...
<br /><br/><br /> 
		<div id="footer">
	      <div class="container">
	        <p class="text-muted">Copyright 2013. Digibeat - Jabatan. All Rights Reserved.</p>
	      </div>
	    </div>
	</body>
</html>